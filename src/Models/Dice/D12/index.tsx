...
export const D12 = () => {
  ...
  const { scene: d12 } = useGLTF("/models/D12/mesh/d12.glb");
  const { scene: d12Collider } = useGLTF("/models/D12/mesh/d12Collider.glb");

  const geometry =
    d12Collider.children[0] instanceof THREE.Mesh
      ? d12Collider.children[0].geometry
      : null;
  if (!geometry) throw new Error("No valid geometry found in d12Collider.glb");
